...
class CreditCardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credit_card" do
    assert_difference('CreditCard.count') do
      post credit_cards_url, params: { credit_card: { card_cvv: @credit_card.card_cvv, card_experation: @credit_card.card_experation, card_name: @credit_card.card_name, card_num: @credit_card.card_num, user_id: @credit_card.user_id } }
    end
  ...
  test "should update credit_card" do
    patch credit_card_url(@credit_card), params: { credit_card: { card_cvv: @credit_card.card_cvv, card_experation: @credit_card.card_experation, card_name: @credit_card.card_name, card_num: @credit_card.card_num, user_id: @credit_card.user_id } }
