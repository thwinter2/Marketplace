...
class CreditCardsTest < ApplicationSystemTestCase
  ...
  test "creating a Credit card" do
    ...
    fill_in "Card cvv", with: @credit_card.card_cvv
    fill_in "Card experation", with: @credit_card.card_experation
    fill_in "Card name", with: @credit_card.card_name
    fill_in "Card num", with: @credit_card.card_num
